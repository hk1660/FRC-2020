 ...
 */
public class SupplyCurrentLimitConfiguration{
    /**
    ...
    public SupplyCurrentLimitConfiguration(double[] doubleArray){
    ...
    public String toString(){
        ...
        if(enable == false){
            ...
            */
            ...
            retstr = "Current Limiting will activate if SUPPLY current exceeds " + effectiveThresholdCurr + " amps for " + triggerThresholdTime + " seconds." + "  Then current will hold at " + currentLimit + " amps";
        }
        return retstr;
    }
    ...
    public boolean equals(SupplyCurrentLimitConfiguration rhs){
        boolean retval = true;
