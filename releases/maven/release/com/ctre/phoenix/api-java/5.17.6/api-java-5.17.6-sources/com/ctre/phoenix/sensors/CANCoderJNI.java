...
public class CANCoderJNI extends CTREJNIWrapper {
	...
	public static native int ConfigGetVelocityMeasurementPeriod(long handle, int timeoutMs);

	public static native int ConfigGetVelocityMeasurementWindow(long handle, int timeoutMs);

	public static native int ConfigGetAbsoluteSensorRange(long handle, int timeoutMs);

	public static native double ConfigGetMagnetOffset(long handle, int timeoutMs);

	public static native int ConfigGetSensorDirection(long handle, int timeoutMs);

	public static native int ConfigGetSensorInitializationStrategy(long handle, int timeoutMs);

    public static native double ConfigGetFeedbackCoefficient(long handle, int timeoutMs);

    public static native String ConfigGetFeedbackUnitString(long handle, int timeoutMs);

    public static native int ConfigGetFeedbackTimeBase(long handle, int timeoutMs);
}